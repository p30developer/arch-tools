...
style:
   ...
   SidebarBackgroundCurrent: "\"${sidebarbackgroundcurrent}"\"" > $1/usr/share/calamares/branding/arch/branding.desc
}
...
clean_up_image(){
	...
	rm -f "$1"/var/lib/arch/partial_upgrade
    rm -rf "$1"/var/lib/arch/tmp/
}
